...
export const LEVEL_CONFIGS: LevelConfig[] = [
  ...
  },
  {
    ...
    description: {
      ko: 'Window Function, CTE, INSERT RETURNING, UPDATE FROM 등을 학습합니다',
      en: 'Learn Window Functions, CTEs, INSERT RETURNING, UPDATE FROM',
    },
    icon: 'Zap',
    color: 'purple',
    problemCount: 12,
  },
  {
    ...
    description: {
      ko: '인덱스, 성능 튜닝, DELETE USING, UPDATE CASE 등 DBA 실무를 학습합니다',
      en: 'Learn DBA skills: indexing, performance tuning, DELETE USING, UPDATE CASE',
    },
    icon: 'Crown',
    color: 'amber',
    problemCount: 12,
